...
#pyrcc4 -o ../pynocchio_comic_reader/main_window_view_rc.py ../resources/main_window_view.qrc

pyside-rcc -o ../../pynocchio_comic_reader/main_window_view_rc.py ../main_window_view.qrc
