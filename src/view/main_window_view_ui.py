...
class Ui_MainWindowView(object):
    def setupUi(self, MainWindowView):
        ...
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap(":/icons/elementary3-icon-theme/actions/64/help-info.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap(":/icons/elementary3-icon-theme/actions/48/application-exit.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap(":/icons/elementary3-icon-theme/actions/48/go-next.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap(":/icons/elementary3-icon-theme/actions/48/go-previous.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon7 = QtGui.QIcon()
        icon7.addPixmap(QtGui.QPixmap(":/icons/elementary3-icon-theme/actions/48/go-first.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon8 = QtGui.QIcon()
        icon8.addPixmap(QtGui.QPixmap(":/icons/elementary3-icon-theme/actions/48/go-last.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon9 = QtGui.QIcon()
        icon9.addPixmap(QtGui.QPixmap(":/icons/elementary3-icon-theme/actions/48/object-rotate-left.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon10 = QtGui.QIcon()
        icon10.addPixmap(QtGui.QPixmap(":/icons/elementary3-icon-theme/actions/48/object-rotate-right.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon11 = QtGui.QIcon()
        icon11.addPixmap(QtGui.QPixmap(":/icons/freeiconmaker-icons/horizontal-fit.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.action_horizontal_fit.setIcon(icon11)
        ...
        icon12 = QtGui.QIcon()
        icon12.addPixmap(QtGui.QPixmap(":/icons/freeiconmaker-icons/fullscreen.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon13 = QtGui.QIcon()
        icon13.addPixmap(QtGui.QPixmap(":/icons/elementary3-icon-theme/actions/48/search.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon14 = QtGui.QIcon()
        icon14.addPixmap(QtGui.QPixmap(":/icons/freeiconmaker-icons/original-fit.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.action_original_fit.setIcon(icon14)
        ...
        icon15 = QtGui.QIcon()
        icon15.addPixmap(QtGui.QPixmap(":/icons/elementary3-icon-theme/actions/64/bookmark_add.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.action_add_bookmark.setIcon(icon15)
        ...
        icon17 = QtGui.QIcon()
        icon17.addPixmap(QtGui.QPixmap(":/icons/elementary3-icon-theme/apps/64/office-database.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.action_bookmark_manager.setIcon(icon17)
        ...
        self.action_bookmark_1 = QtGui.QAction(MainWindowView)
        icon24 = QtGui.QIcon()
        icon24.addPixmap(QtGui.QPixmap(":/icons/elementary3-icon-theme/actions/48/dialog-apply.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.action_bookmark_1.setIcon(icon24)
        self.action_bookmark_1.setText("bookmark_1")
        self.action_bookmark_1.setVisible(False)
        self.action_bookmark_1.setObjectName("action_bookmark_1")
        self.action_bookmark_2 = QtGui.QAction(MainWindowView)
        self.action_bookmark_2.setIcon(icon24)
        self.action_bookmark_2.setVisible(False)
        self.action_bookmark_2.setObjectName("action_bookmark_2")
        self.action_bookmark_3 = QtGui.QAction(MainWindowView)
        self.action_bookmark_3.setIcon(icon24)
        self.action_bookmark_3.setVisible(False)
        self.action_bookmark_3.setObjectName("action_bookmark_3")
        self.action_bookmark_4 = QtGui.QAction(MainWindowView)
        self.action_bookmark_4.setIcon(icon24)
        self.action_bookmark_4.setVisible(False)
        self.action_bookmark_4.setObjectName("action_bookmark_4")
        self.action_bookmark_5 = QtGui.QAction(MainWindowView)
        self.action_bookmark_5.setIcon(icon24)
        self.action_bookmark_5.setVisible(False)
        self.action_bookmark_5.setObjectName("action_bookmark_5")
        self.actionTete = QtGui.QAction(MainWindowView)
        self.actionTete.setObjectName("actionTete")
        self.action_recent_file_1 = QtGui.QAction(MainWindowView)
        self.action_recent_file_1.setIcon(icon24)
        self.action_recent_file_1.setVisible(False)
        self.action_recent_file_1.setObjectName("action_recent_file_1")
        self.action_recent_file_2 = QtGui.QAction(MainWindowView)
        self.action_recent_file_2.setIcon(icon24)
        self.action_recent_file_2.setVisible(False)
        self.action_recent_file_2.setObjectName("action_recent_file_2")
        self.action_recent_file_3 = QtGui.QAction(MainWindowView)
        self.action_recent_file_3.setIcon(icon24)
        self.action_recent_file_3.setVisible(False)
        self.action_recent_file_3.setObjectName("action_recent_file_3")
        self.action_recent_file_4 = QtGui.QAction(MainWindowView)
        self.action_recent_file_4.setIcon(icon24)
        self.action_recent_file_4.setVisible(False)
        self.action_recent_file_4.setObjectName("action_recent_file_4")
        self.action_recent_file_5 = QtGui.QAction(MainWindowView)
        self.action_recent_file_5.setIcon(icon24)
        self.action_recent_file_5.setVisible(False)
        self.action_recent_file_5.setObjectName("action_recent_file_5")
        self.action_open_online = QtGui.QAction(MainWindowView)
        self.action_open_online.setEnabled(False)
        icon25 = QtGui.QIcon()
        icon25.addPixmap(QtGui.QPixmap(":/icons/elementary3-icon-theme/categories/48/applications-internet.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.action_open_online.setIcon(icon25)
        self.action_open_online.setVisible(False)
        self.action_open_online.setObjectName("action_open_online")
        self.menu_recent_files.addAction(self.action_recent_file_1)
        self.menu_recent_files.addAction(self.action_recent_file_2)
        self.menu_recent_files.addAction(self.action_recent_file_3)
        self.menu_recent_files.addAction(self.action_recent_file_4)
        self.menu_recent_files.addAction(self.action_recent_file_5)
        self.menu_file.addAction(self.action_open)
        self.menu_file.addAction(self.action_open_folder)
        self.menu_file.addAction(self.action_open_online)
        ...
        self.menu_recent_bookmarks.addAction(self.action_bookmark_1)
        self.menu_recent_bookmarks.addAction(self.action_bookmark_2)
        self.menu_recent_bookmarks.addAction(self.action_bookmark_3)
        self.menu_recent_bookmarks.addAction(self.action_bookmark_4)
        self.menu_recent_bookmarks.addAction(self.action_bookmark_5)
    ...
    def retranslateUi(self, MainWindowView):
        ...
        self.action_open.setText(QtGui.QApplication.translate("MainWindowView", "&Open", None, QtGui.QApplication.UnicodeUTF8))
        self.action_open.setShortcut(QtGui.QApplication.translate("MainWindowView", "Ctrl+O", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.action_show_statusbar.setText(QtGui.QApplication.translate("MainWindowView", "S&how Statusbar", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.action_bookmark_1.setIconText(QtGui.QApplication.translate("MainWindowView", "bookmark", None, QtGui.QApplication.UnicodeUTF8))
        self.action_bookmark_1.setToolTip(QtGui.QApplication.translate("MainWindowView", "bookmark", None, QtGui.QApplication.UnicodeUTF8))
        self.action_bookmark_2.setText(QtGui.QApplication.translate("MainWindowView", "bookmark_2", None, QtGui.QApplication.UnicodeUTF8))
        self.action_bookmark_3.setText(QtGui.QApplication.translate("MainWindowView", "bookmark_3", None, QtGui.QApplication.UnicodeUTF8))
        self.action_bookmark_4.setText(QtGui.QApplication.translate("MainWindowView", "bookmark_4", None, QtGui.QApplication.UnicodeUTF8))
        self.action_bookmark_5.setText(QtGui.QApplication.translate("MainWindowView", "bookmark_5", None, QtGui.QApplication.UnicodeUTF8))
        self.actionTete.setText(QtGui.QApplication.translate("MainWindowView", "tete", None, QtGui.QApplication.UnicodeUTF8))
        self.action_recent_file_1.setText(QtGui.QApplication.translate("MainWindowView", "recent_file_1", None, QtGui.QApplication.UnicodeUTF8))
        self.action_recent_file_2.setText(QtGui.QApplication.translate("MainWindowView", "recent_file_2", None, QtGui.QApplication.UnicodeUTF8))
        self.action_recent_file_3.setText(QtGui.QApplication.translate("MainWindowView", "recent_file_3", None, QtGui.QApplication.UnicodeUTF8))
        self.action_recent_file_4.setText(QtGui.QApplication.translate("MainWindowView", "recent_file_4", None, QtGui.QApplication.UnicodeUTF8))
        self.action_recent_file_5.setText(QtGui.QApplication.translate("MainWindowView", "recent_file_5", None, QtGui.QApplication.UnicodeUTF8))
