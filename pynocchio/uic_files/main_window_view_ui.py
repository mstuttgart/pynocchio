...
class Ui_MainWindowView(object):
    def setupUi(self, MainWindowView):
        ...
        self.action_double_page_mode.setEnabled(True)
        icon27 = QtGui.QIcon()
        icon27.addPixmap(QtGui.QPixmap(":/icons/elementary3-icon-theme/actions/22/align-vertical-bottom.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.action_single_page_mode = QtWidgets.QAction(MainWindowView)
        self.action_single_page_mode.setCheckable(False)
        icon28 = QtGui.QIcon()
        icon28.addPixmap(QtGui.QPixmap(":/icons/elementary3-icon-theme/actions/48/media-playback-start.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.action_single_page_mode.setIcon(icon28)
        self.action_single_page_mode.setObjectName("action_single_page_mode")
        ...
        self.menu_view.addAction(self.action_single_page_mode)
    ...
    def retranslateUi(self, MainWindowView):
        ...
        self.action_single_page_mode.setText(_translate("MainWindowView", "Single Page Mode"))
