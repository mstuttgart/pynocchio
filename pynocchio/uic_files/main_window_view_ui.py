...
class Ui_MainWindowView(object):
    def setupUi(self, MainWindowView):
        ...
        icon22 = QtGui.QIcon()
        icon22.addPixmap(QtGui.QPixmap(":/icons/icons/distribute-horizontal-margin.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.action_double_page_mode.setIcon(icon22)
