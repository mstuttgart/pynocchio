...
class Ui_MainWindowView(object):
    def setupUi(self, MainWindowView):
        ...
        self.qscroll_area_viewer.setFocusPolicy(QtCore.Qt.NoFocus)
        ...
        self.qscroll_area_viewer.setVerticalScrollBarPolicy(QtCore.Qt.ScrollBarAsNeeded)
        self.qscroll_area_viewer.setHorizontalScrollBarPolicy(QtCore.Qt.ScrollBarAsNeeded)
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap(":/icons/icons/system-shutdown.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap(":/icons/icons/go-first.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap(":/icons/icons/go-last.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon7 = QtGui.QIcon()
        icon7.addPixmap(QtGui.QPixmap(":/icons/icons/object-rotate-left.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon8 = QtGui.QIcon()
        icon8.addPixmap(QtGui.QPixmap(":/icons/icons/object-rotate-right.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon9 = QtGui.QIcon()
        icon9.addPixmap(QtGui.QPixmap(":/icons/icons/horizontal-fit.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon10 = QtGui.QIcon()
        icon10.addPixmap(QtGui.QPixmap(":/icons/icons/fullscreen.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon11 = QtGui.QIcon()
        icon11.addPixmap(QtGui.QPixmap(":/icons/icons/edit-find.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon12 = QtGui.QIcon()
        icon12.addPixmap(QtGui.QPixmap(":/icons/icons/original-fit.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon13 = QtGui.QIcon()
        icon13.addPixmap(QtGui.QPixmap(":/icons/icons/bookmark-new.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon14 = QtGui.QIcon()
        icon14.addPixmap(QtGui.QPixmap(":/icons/icons/edit-delete.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon15 = QtGui.QIcon()
        icon15.addPixmap(QtGui.QPixmap(":/icons/icons/system-file-manager2.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon16 = QtGui.QIcon()
        icon16.addPixmap(QtGui.QPixmap(":/icons/icons/document-open.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon17 = QtGui.QIcon()
        icon17.addPixmap(QtGui.QPixmap(":/icons/icons/media-skip-forward.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon18 = QtGui.QIcon()
        icon18.addPixmap(QtGui.QPixmap(":/icons/icons/media-skip-backward.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon20 = QtGui.QIcon()
        icon20.addPixmap(QtGui.QPixmap(":/icons/icons/vertical-fit.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon21 = QtGui.QIcon()
        icon21.addPixmap(QtGui.QPixmap(":/icons/icons/best-fit.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.action_page_fit = QtWidgets.QAction(MainWindowView)
        self.action_page_fit.setCheckable(True)
        self.action_page_fit.setChecked(False)
        self.action_page_fit.setEnabled(False)
        icon22 = QtGui.QIcon()
        icon22.addPixmap(QtGui.QPixmap(":/icons/icons/page-fit.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.action_page_fit.setIcon(icon22)
        self.action_page_fit.setVisible(True)
        self.action_page_fit.setObjectName("action_page_fit")
        ...
        icon23 = QtGui.QIcon()
        icon23.addPixmap(QtGui.QPixmap(":/icons/icons/archive-extract.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.action_page_across_files = QtWidgets.QAction(MainWindowView)
    ...
    def retranslateUi(self, MainWindowView):
        ...
        self.menu_recent_bookmarks.setTitle(_translate("MainWindowView", "R&ecent bookmarks"))
        ...
        self.action_page_fit.setText(_translate("MainWindowView", "&Page fit"))
        self.action_page_fit.setShortcut(_translate("MainWindowView", "Ctrl+P"))
        ...
        self.action_double_page_mode.setToolTip(_translate("MainWindowView", "Enable double page mode"))
