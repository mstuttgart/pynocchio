...
class Ui_Bookmark_Dialog(object):
    def setupUi(self, Bookmark_Dialog):
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(":/icons/icons/applications-libraries.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap(":/icons/icons/archive-extract.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
